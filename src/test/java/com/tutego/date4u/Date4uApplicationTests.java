...
//@DirtiesContext //restarts context before each test
@SpringBootTest
@TestPropertySource(locations = "classpath:test.properties",properties = "spring.shell.interactive.enabled=false")
